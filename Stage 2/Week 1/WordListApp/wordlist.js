function validateANDadd() {
    ...
    // validate that a 1, 2 or 3 was entered as a number
    else if ((theNewNumber != 1) && (theNewNumber != 2) && (theNewNumber != 3)) {
      // a 1, 2 or 3 was not entered as the number so tell user and clear the field
      alert("Please enter a 1, 2 or 3 for the list.");
      document.forms["myForm"]["newNumber"].value = "";
      return false;
    }
    else {
        // a word was entered and a 1, 2 or 3 was entered as the number 

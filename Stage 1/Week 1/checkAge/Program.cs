//This program will request the user to input their age and check to make sure it's between 0 and 120. If it is not between
//0 and 120, it will output an error message asking them to input a new number.
...
class AgeValidator
{
 /* do
      ...
      if age is an integer then
             if age is in a valid range (0-120)
                then print that it is valid, exit the loop
             else
                 provide a range error message
